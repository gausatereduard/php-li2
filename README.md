...
| Описание | Скриншот |
|----------|----------|
| Главная страница (для авторизованного пользователя) | ![Главная страница](./screenshots/home.png) |
| Главная страница (для гостя) | ![Главная гость](./screenshots/home-guest.jpeg) |
| Страница входа | ![Вход](./screenshots/login.png) |
| Регистрация | ![Регистрация](./screenshots/register.png) |
| Список кошельков | ![Кошельки](./screenshots/wallets.png) |
| Создание кошелька | ![Создать кошелек](./screenshots/wallet-create.png) |
| Список транзакций | ![Транзакции](./screenshots/transactions.png) |
| Создание транзакции | ![Создать транзакцию](./screenshots/transaction-create.png) |
| Поиск транзакций | ![Поиск](./screenshots/transaction-search.png) |
| Бюджеты | ![Бюджеты](./screenshots/budget.png) |
...
1. При запросе `/transactions` роутер ищет маршрут
...
3. **Router** `POST /transactions/create`
